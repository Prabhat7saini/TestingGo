...
import (
	...
	// "gitlab.com/truemeds-dev-team/truemeds-dev-doctor/truemeds-dev-service/doctorportal-auth-service/api/routes"
	// "gitlab.com/truemeds-dev-team/truemeds-dev-doctor/truemeds-dev-service/doctorportal-auth-service/api/routes"
	"gitlab.com/truemeds-dev-team/truemeds-dev-doctor/truemeds-dev-service/doctorportal-auth-service/api/routes"
...
type App struct {
	...
	service *intitalizer.BaseService
	handler *intitalizer.BaseHandler
}
...
func (a *App) initialize() {
	...
	a.service = intitalizer.NewBaseService(a.redis, a.log, a.cfg, a.repo)
	a.handler = intitalizer.NewBaseHandler(a.log, a.cfg, a.service)
